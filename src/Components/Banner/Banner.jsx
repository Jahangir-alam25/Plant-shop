...
const Banner = () => {
    return (
        <div>
            <div
                className="w-11/12 my-5 mx-auto grid md:grid-cols-12 grid-rows-2 min-h-screen gap-5">
                ...
                <div className="col-span-3 rounded">
                    <div className="card rounded-2xl p-6 border border-gray-200">
                        ...
                        <p className="text-gray-600 mt-2">
                            Get <span className="text-red-500 font-semibold">20% OFF</span> on your
                            next purchase!
                        </p>
                        <div
                            className="flex items-center justify-between mt-4 p-4 bg-gray-50 rounded-lg"
                        >
                            <span className="text-lg font-semibold text-gray-700">Code:</span>
                            <span
                                className="text-lg font-bold text-blue-600 bg-blue-100 px-4 py-1 rounded-lg"
                            >SAVE20</span>
                        </div>
                ...
                <div className="col-span-3 rounded">
                    <div className="card rounded-2xl p-6 border border-gray-200">
                        <h2 className="text-xl font-bold text-gray-800">Special Discount</h2>
                        <p className="text-gray-600 mt-2">
                            Get <span className="text-red-500 font-semibold">50% OFF</span> on your
                            First delivery
                        </p>
                        <div
                            className="flex items-center justify-between mt-4 p-4 bg-gray-50 rounded-lg">
                            <span className="text-lg font-semibold text-gray-700">Code:</span>
                            <span
                                className="text-lg font-bold text-blue-600 bg-blue-100 px-4 py-1 rounded-lg">Free50</span>
                        </div>
                        <button className="btn btn-success text-white w-full mt-4">
                            Redeem Now
                        </button>
            ...
            <div>
                <h2
                    ...
                    <div className="backdrop-blur py-10 text-gray-700 flex justify-center">
                        <FaShoppingBag />
                        <p>
                            Let's Shop
                        </p>
